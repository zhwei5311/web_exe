...
<link rel="stylesheet"
	...
	<script>
		function delStudent(id){
		    if(confirm("您确认要删除吗")){
		        location.href="${pageContext.request.contextPath}/student/remove.action/"+id;
			}
		}
	</script>
								...
								<tbody>
									<c:forEach items="${studentList}" var="student">
										<tr>
											...
											<td >
												<a onclick="location.href='${pageContext.request.contextPath}/student/edit/'+${student.studentno}" class="btn bg-olive btn-xs">修改</a>
