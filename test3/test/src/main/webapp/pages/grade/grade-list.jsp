...
<link rel="stylesheet"
	...
	<script>
		function delGrade(id){
		    if(confirm("您确认要删除吗")){
		        location.href="${pageContext.request.contextPath}/grade/delete.action/"+id;
			}
		}
	</script>
								...
								<tbody>
									<c:forEach items="${gradeList}" var="grade">
										<tr>
											...
											<td>${grade.address}</td>
											<td >
												<a onclick="location.href='${pageContext.request.contextPath}/grade/edit/${grade.gradeid}'" class="btn bg-olive btn-xs">修改</a>
												<a href="javascript:void(0)" onclick="delGrade(${grade.gradeid})" class="btn bg-olive btn-xs">删除</a>
												<a href="${pageContext.request.contextPath}/student/findAll.action/${grade.gradeid}" class="btn bg-olive btn-xs">查看班级学员</a>
											</td>
										</tr>
									</c:forEach>
